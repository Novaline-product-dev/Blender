...
def ksFunctionGeneratorW2V(text_list, grid_pts = 500):
    """ Takes a list of lists as an argument, where each sub-list has tokens.  It returns a new function that evaluates the Kolmogorov-Smirnov distance of a new idea from the baseline CDF generated by text_list.  Other version uses Jaccard Indices, this uses w2v similarities from spaCy"""
    ###################  working on the next block of code
