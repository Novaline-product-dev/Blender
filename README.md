...
4. The new stimulus words are POS-tagged and embedded in a sentence which suggests a way innovate on the seed term.  For example, if a user entered "3D printing" as a seed term, an output might be: "Try blending 3D printing with a photo."
...
*  Improve Blender by adding functionality, such as 
  ...
  3. A loop mechanism whereby Blender iterates and improves upon its original suggestions in response user feedback.